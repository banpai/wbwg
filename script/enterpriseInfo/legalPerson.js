        ...
        created: function() {
          ...
          if (param != "" && param.status != "" && param.status != undefined) {
            ...
            if (this.mStatus == "isBrownse") {
              ...
              console.log(JSON.stringify(this.infoJson));
        ...
        methods: {
            ...
            setDataToView:function(){
              ...
              if (that.mStatus == "isBrownse") {
                  ...
                  that.taxplace =  that.infoJson.taxLocation;//纳税地点
                  that.registplace =  that.infoJson.registrationLocation;//注册地点
                  //单位性质
            ...
            submit: function() {
                if (this.mStatus == "isBrownse") {
                    ...
                    if (this.checkValue()) {
                        ...
                        if(this.taxplace){
                            enterpriseJson.taxLocation=this.taxplace;//纳税地点
                        }
                        if(this.registplace){
                          enterpriseJson.registrationLocation=this.registplace;//注册地点
                        }
