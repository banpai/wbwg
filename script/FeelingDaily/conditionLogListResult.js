    ...
    var vue = new Vue({
      ...
      methods:{
          loadList:function(){
            ...
            this.params.personName = this.personName;
            console.log(JSON.stringify(this.params));
            var _self = this;
            console.log(UICore.serviceUrl + 'mobile/mobilePeopleLog.shtml?act=getPeopleLogByAccount&data=' + JSON.stringify(this.params));
            api.ajax({
                url: UICore.serviceUrl + 'mobile/mobilePeopleLog.shtml?act=getPeopleLogByAccount&data=' + JSON.stringify(this.params),
                method: 'get',
            },function(ret, err){
